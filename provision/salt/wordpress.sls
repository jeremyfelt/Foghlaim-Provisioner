...
wp-cli:
  cmd.run:
    - name: curl -L https://github.com/wp-cli/wp-cli/releases/download/v0.17.0/wp-cli.phar > wp-cli.phar > wp-cli.phar && mv wp-cli.phar /usr/bin/wp && chmod +x /usr/bin/wp
    - cwd: /tmp
    - unless: wp --allow-root --version | grep "0.17.0"
    - require:
      - pkg: php-fpm
